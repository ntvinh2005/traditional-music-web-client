...
const Register = () => {
  ...
  return (
    <div className="bg-yellow-50 h-screen">
      <div >
        <div className="flex min-h-full items-center justify-center py-0 px-4 sm:px-6 lg:px-8">
          <div className="w-full max-w-md space-y-8">
            ...
            <form className="mt-8 space-y-6 rounded bg-white p-5 shadow" onSubmit={register}>
              ...
              <div className="-space-y-px rounded-md shadow-sm">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={onChangeRegisterForm}
                    required
                    className="relative block w-full appearance-none rounded-none border border-gray-300 px-3 py-2 text-gray-900 placeholder-gray-500 focus:z-10 focus:border-yellow-500 focus:outline-none focus:ring-yellow-500 sm:text-sm"
